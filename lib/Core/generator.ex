defmodule SpritePacker.Core.Generator do
  ...
  defp create_image_generation_command({width, height}, block_list) do
    image_generation_command =  ["convert -define png:exclude-chunks=date -quality 0% -size #{width}x#{height} xc:none"]
  ...
  defp append_command_endpart(image_generation_command) do
    ["#{@dest_dir}/spriteatlas.png" | image_generation_command] |> Enum.reverse() |> Enum.join(" ")
  end
